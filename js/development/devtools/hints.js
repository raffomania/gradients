...
var map__11657 = top_item;
var map__11657__$1 = cljs.core.__destructure_map.call(null,map__11657);
var file = cljs.core.get.call(null,map__11657__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11657__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11657__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e11656){var _e = e11656;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___11658 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___11658)){
var seen_errors_11659 = temp__5751__auto___11658;
if(cljs.core.truth_(seen_errors_11659.has(self))){
} else {
seen_errors_11659.add(self);

var temp__5753__auto___11660 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___11660)){
var sense_11661 = temp__5753__auto___11660;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11661)].join(''));
} else {
}
}
} else {
