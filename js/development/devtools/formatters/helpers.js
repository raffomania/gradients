...
var G__9775 = devtools.prefs.pref.call(null,v);
v = G__9775;
continue;
} else {
return v;
...
var and__4221__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4221__auto__){
var and__4221__auto____$1 = (!(cljs.core.var_QMARK_.call(null,value)));
...
var or__4223__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e9776){var _e__9052__auto__ = e9776;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var or__4223__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e9778){var _e__9052__auto__ = e9778;
return false;
}})();
...
}catch (e9780){var _e__9052__auto__ = e9780;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__4221__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__4221__auto__)){
var and__4221__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_.call(null,f)));
if(and__4221__auto____$1){
...
var and__4221__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__4221__auto__)){
...
var or__4223__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var and__4221__auto__ = (function (){var or__4223__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var vec__9782 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9782,(0),null);
var name = cljs.core.nth.call(null,vec__9782,(1),null);
...
var and__4221__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__4221__auto__)){
...
return cljs.core.some.call(null,(function (p1__9785_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9785_SHARP_);
}),template);
});
