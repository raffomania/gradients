...
var G__9701 = devtools.prefs.pref.call(null,v);
v = G__9701;
continue;
} else {
return v;
...
}catch (e9702){var _e__8984__auto__ = e9702;
return false;
}})();
...
}catch (e9704){var _e__8984__auto__ = e9704;
return false;
}})();
...
}catch (e9706){var _e__8984__auto__ = e9706;
return false;
}}
}
});
...
var vec__9708 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9708,(0),null);
var name = cljs.core.nth.call(null,vec__9708,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9711_SHARP_);
}),template);
});
