...
var and__4221__auto____$1 = (!(oops.helpers.is_prototype_QMARK_.call(null,f)));
...
var G__2221 = cljs.core.next.call(null,items);
items = G__2221;
continue;
} else {
return arr;
...
var x2222 = error;
(x2222.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x2222.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__2223 = Object.getPrototypeOf(o);
o = G__2223;
continue;
} else {
...
var or__4223__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5757__auto__ = (goog.global["devtools"]);
