...
var G__3815 = cljs.core.first.call(null,element_str);
switch (G__3815) {
case "?":
arr.push((1));
...
var G__3817 = cljs.core.next.call(null,items);
items = G__3817;
continue;
} else {
return null;
...
var G__3818 = cljs.core.next.call(null,items);
items = G__3818;
continue;
} else {
return null;
...
var G__3820 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__3820;
continue;
} else {
return true;
...
switch (G__3823) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__3821_SHARP_){
return cljs.core.not_EQ_.call(null,p1__3821_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,(function (p1__3822_SHARP_){
return cljs.core.not_EQ_.call(null,p1__3822_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3823)].join('')));
